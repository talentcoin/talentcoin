...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "TALENT " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"TALENTtools.com", "dnsseed.TALENTtools.com"},
    {"TALENTpool.org", "dnsseed.TALENTpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"TALENTtools.com", "testnet-seed.TALENTtools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TALENT is probably already running."), addrBind.ToString().c_str());
        else
